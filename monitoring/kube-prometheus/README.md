...
https://www.youtube.com/watch?v=BXjLHhMiTmU

repo: git clone `https://github.com/prometheus-operator/kube-prometheus`
cd kube-prometheus

## Instalar so CDRs

kubectl create -f manifestes/setup

kubectl get customresourcedefinitions.apiextensions.k8s.io -n monitoring

kubectl apply -f manifestes/

kubectl port-forward -n monitoring svc/prometheus-k8s 9090:9090

abrir no browser localhost:9090

kubectl port-forward -n monitoring svc/grafana 3000:300
